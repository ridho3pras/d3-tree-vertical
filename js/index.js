...
function update(source) {
  ...
  nodeEnter
    ...
    .on("mousedown", function (d) {
      d.children || d._children ? "" : nodeClick(d, this);
    });
  ...
  nodeEnter
    ...
    .text(function (d) {
      return d.children || d._children
        ? d.name + " (" + d.children.length + ")"
        : d.name;
    })
    .style("fill-opacity", 1e-6)
    .attr("id", function (d) {
      return "text_id_" + d.id;
    })
    .on("mousedown", function (d) {
      d.children || d._children ? "" : nodeClick(d, this);
    });
...
function nodeClick(d, i) {
  ...
  $("#stream_name")
    .empty()
    .append(d.parent.parent ? d.parent.parent.name : "");
